...
Android/iOS app for musical instruments tuning according to non-usual musical temperaments and learning some of the concepts behind it.

A short Ionic Capacitor React project made for an internship. :mortar_board:

The project is still in the early stage of the development and might be unstable on non-tested plateforms.
...
Keep in mind that :
- The app is tested on Android
- Testing on iOS requires to have an Apple device
