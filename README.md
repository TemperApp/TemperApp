...
Progressive web app for musical instruments tuning in unequal temperaments and learning some of the concepts behind it.

A short Ionic Capacitor React project made for an internship. :mortar_board:

The project is still in the stage of the development and might be unstable.
...
```
git clone https://github.com/benjaminbriere/temperapp
```
```
cd temperapp
