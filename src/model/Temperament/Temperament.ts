  ...
  
{
    ...
    procedure : "A4;A4-A3;A3-F3;F3-F4;{on divise la tierce F-A en quatre quintes tempérées à -1/4 de Comma syntonique}F3-C4;C4-G3;G3-G4;G3-D4;A3:D4;{on construit les tierces pures sur les notes accordées}C4-E4;G3-B3;D4-F#4;A3-C#4;E4-G#4;G#4-G#3;{on accorde les quintes Sib-Fa et Mib-Sib, pour cela:}{on accord Sib-Fa d’abord pur, ensuite on tempère en comparant avec la quinte La-Mi et Si-Fa# déjà accordées}Bb3-F4;{pour accorder Mib-Sib on procède en accordant la quarte Sib-Mib plus petite que pure, étant la quinte plus grande}D#-Bb{comparer avec La-Re et Si-Mi};G# :D#;",
