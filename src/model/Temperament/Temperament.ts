  ...
  
{
    ...
    procedure : "A4;A4-A3;{La tierce fa-la est pure}A3-F3;F3-F4;{On répartit les quatre quintes intérieures à fa-la de manière égale, au quart de comma syntonique}F3-C4;C4-G3;G3-G4;G4-D4;{On vérifie l’intervalle D4-G3 tempéré au quart de comma}D4-G3;A3-E4;E4-B3;B3-F#4;F#4-F#3;{On procède à l’accord des cinq quintes élargies}F#3-C#4;C#4-G#3;G#3-G#4;G#4-Eb4;Eb4-Bb3;Bb3-F4;",
    theorist : "Friedrich Wilhelm Marpurg (1718-1795)",
    period : "1756",
    geographicalArea: "Allemagne, France",
    nature: "Comma syntonique",
    structuralParticularity: "Quatre tierces sont pures, sept quintes sont tempérées au quart de comma syntonique, les cinq quintes restantes sont plus grandes que pures.",
    sources: [
      {author: "Friedrich Wilhelm Marpurg", book: "Principes de clavecin", title: "", other: "", date: "1756", page: "", url: "https://imslp.org/wiki/Anleitung_zum_Clavierspielen_(Marpurg%2C_Friedrich_Wilhelm)"},
      {author: "Friedrich Wilhelm Marpurg", book: "Versuch über die musikalische Temperatur", title: "", other: "", date: "1776", page: "", url: "https://imslp.org/wiki/Versuch_%C3%BCber_die_musikalische_Temperatur_(Marpurg%2C_Friedrich_Wilhelm)"},
    ],
    soundReferences: [
      {title: "", url: ""},
      {title: "", url: ""},
  ...
  
{
    ...
    procedure : "A4;A4-A3;A3-F3;F3-F4;{on divise la tierce F-A en quatre quintes tempérées à -1/4 de Comma syntonique}F3-C4;C4-G3;G3-G4;G3-D4;A3:D4;{on construit les tierces pures sur les notes accordées}C4-E4;G3-B3;D4-F#4;A3-C#4;E4-G#4;G#4-G#3;{on accorde les quintes Sib-Fa et Mib-Sib, pour cela:}{on accord Sib-Fa d’abord pur, ensuite on tempère en comparant avec la quinte La-Mi et Si-Fa# déjà accordées}Bb3-F4;{pour accorder Mib-Sib on procède en accordant la quarte Sib-Mib plus petite que pure, étant la quinte plus grande}Bb3-D#4{comparer avec La-Re et Si-Mi};G#3:D#4;",
    ...
    sources: [
      {author: "Lambert Chaumont", book: "Pièces d'orgue dans les huit tons, Huy, 1695", title: "", other: "", date: "1695", page: "", url: "https://imslp.org/wiki/Pi%C3%A8ces_d%E2%80%99orgue_sur_les_8_tons_(Chaumont%2C_Lambert)"},
    ],
    soundReferences: [
      {title: "", url: ""},
      {title: "", url: ""},
