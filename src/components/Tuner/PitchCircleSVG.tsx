...
const PitchCircleSVG: React.FC = () => {
  ...
  const [stateButton, setStateButton] = useState(StateArray);

  useEffect(() => {

    StateArray["E"]=true;
    setStateButton(StateArray);
